...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      link: 'https://www.linkedin.com/in/Idumachika/',
      name: 'Iduma Chika',
      role: 'Senior react native developer . Improving open-source projects, one commit at a time.',
      test: 'As a developer and problem solver, I have had the pleasure of collaborating with Ibiam on various Javascript and React projects. Over time, I have observed his consistent progress in understanding the development process, making him an excellent partner to have. Ibiam always maintains a professional demeanor and ensures good audio and video quality, which facilitates effective communication.',
    },
    // {
    //   id: 2,
